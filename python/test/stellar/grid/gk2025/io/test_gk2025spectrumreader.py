...
from pfs.ga.pfsspec.stellar.grid.gk2025.io import GK2025SpectrumReader

class TestGK2025SpectrumReader(TestBase):
    def test_get_filename(self):
        reader = GK2025SpectrumReader(format='fits', resolution=5000)
    ...
    def test_parse_filename(self):
        ...
        p = GK2025SpectrumReader.parse_filename(fn)
    ...
    def test_read(self):
        ...
        r = GK2025SpectrumReader(filename, format='ascii', resolution=5000)
        spec = r.read()
    ...
    def test_read_fits(self):
        ...
        r = GK2025SpectrumReader(filename, format='fits', resolution=50000)
        spec = r.read()